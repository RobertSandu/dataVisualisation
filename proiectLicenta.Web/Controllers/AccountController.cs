...
using proiectLicenta.Web.Controllers.Results;
using proiectLicenta.Web.Models.Account;
using Microsoft.AspNet.Identity;
using Microsoft.AspNet.Identity.Owin;
using Microsoft.Owin.Security;

namespace proiectLicenta.Web.Controllers
{
    public class AccountController : proiectLicentaControllerBase
    {
