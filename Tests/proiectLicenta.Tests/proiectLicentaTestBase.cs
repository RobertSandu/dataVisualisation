...
namespace proiectLicenta.Tests
{
    public abstract class proiectLicentaTestBase : AbpIntegratedTestBase
    {
        protected proiectLicentaTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<proiectLicentaApplicationModule>();
            modules.Add<proiectLicentaDataModule>();
        }

        public void UsingDbContext(Action<proiectLicentaDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<proiectLicentaDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<proiectLicentaDbContext, T> func)
        {
            T result;
